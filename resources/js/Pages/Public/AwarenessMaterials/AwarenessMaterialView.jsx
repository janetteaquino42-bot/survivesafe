...
export default function AwarenessMaterialView({ material, relatedMaterials, hero }) {
    ...
    return (
        <GuestLayout>
            <Head title={`${material.title} - Bacoor DRRMO`}>
                <meta name="description" content={material.description?.substring(0, 160)} />
                <meta property="og:title" content={material.title} />
                <meta property="og:description" content={material.description?.substring(0, 160)} />
                <meta property="og:type" content="article" />
                <meta property="og:url" content={window.location.href} />
                <meta name="twitter:card" content="summary_large_image" />
                <meta name="twitter:title" content={material.title} />
                <meta name="twitter:description" content={material.description?.substring(0, 160)} />
                                    ...
                                    <div className="bg-white rounded-xl shadow-lg p-6">
                                        ...
                                        <div className="space-y-4">
                                            {relatedMaterials.slice(0, 5).map((related) => (
                                                <Link
                                                    key={related.id}
                                                    href={route('public.awareness.show', related.id)}
