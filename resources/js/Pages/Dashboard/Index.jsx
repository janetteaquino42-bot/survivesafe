...
const NAVIGATION_ITEMS = [
    ...
    { label: "Hazard Map", href: "/officer/hazard-map", icon: Activity, roles: ['resident', 'officer', 'head_officer', 'pending'] },
            ...
            <div className="py-4 sm:py-6 lg:py-8">
                <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
                    ...
                    <div className="mb-4 sm:mb-6 lg:mb-8">
                        <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 line-clamp-2">Dashboard</h1>
                        <p className="text-sm sm:text-base text-gray-600 mt-1 line-clamp-2">
                            Overview of incident reports, statistics, and recent activities in your community.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
                        ...
                        <Card>
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 sm:mb-4 gap-2">
                                <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 line-clamp-1">Recent Incidents</h2>
                                <a href={route('officer.hazard-map')} className="text-xs sm:text-sm text-blue-600 hover:text-blue-700 font-medium whitespace-nowrap">
                                    View All
                                </a>
                            </div>
                                    ...
                                    recentIncidents.map((incident) => (
                                        <div key={incident.id} className="border-b border-gray-200 pb-3 sm:pb-4 last:border-0">
                                            ...
                                            <div className="flex justify-between items-center text-xs text-gray-500 gap-2">
                                                ...
                                                <span className="whitespace-nowrap flex-shrink-0">{incident.created_at}</span>
                                            </div>
                                        </div>
                                    ))
                                ) : (
                        ...
                        <Card>
                            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-3 sm:mb-4 gap-2">
                                <h2 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900 line-clamp-1">Recent Announcements</h2>
                                ...
                                {recentAnnouncements.length > 0 ? (
                                    recentAnnouncements.map((announcement) => (
                                        <div key={announcement.id} className="border-b border-gray-200 pb-3 sm:pb-4 last:border-0">
                                            ...
                                            <div className="flex justify-between items-center text-xs text-gray-500 gap-2">
                                                <span className="truncate">By {announcement.creator_name}</span>
                                                <span className="whitespace-nowrap flex-shrink-0">{announcement.created_at}</span>
                                            </div>
                                        </div>
                                    ))
                                ) : (
