...
import { MapPin, Calendar, User, AlertCircle, Activity, CheckCircle, Trash2, XCircle, Circle } from 'lucide-react';
                    ...
                    <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <div>
                            ...
                            <p className="text-sm sm:text-base text-gray-600 mt-1">
                                {isHeadOfficer
                                    ? 'Manage community hazard incidents and reports.'
                                    : canManage
                                        ? 'Manage hazard incidents and reports.'
                                        ...
                                        >
                                            ...
                                            {canChangeStatus && (
                                                <div className="flex gap-2 flex-col sm:flex-row">
                                                    {/* Mark as Reviewed/Decline Button */}
                                                    {incident.status === 'active' && (
                                                        <>
                                                            <PrimaryButton
                                                                className="sm:flex-1 text-xs sm:text-sm px-3 py-2 justify-center"
                                                    ...
                                                    {incident.status === 'verified' && (
                                                        <>
                                                            <SuccessButton
                                                                className="flex-1 text-xs sm:text-sm px-3 py-2 justify-center"
                                                                onClick={() => openConfirmModal('status', incident, 'resolved')}
                                                            >
                                                                <CheckCircle size={14} className="mr-1" />
                                                                <span>Mark as Resolved</span>
                                                            </SuccessButton>
                                                            {/* Archive Button - only show for verified incidents */}
                                                            <DangerButton
