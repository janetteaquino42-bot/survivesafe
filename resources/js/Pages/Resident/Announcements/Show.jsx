...
export default function AnnouncementView({ announcement, previousAnnouncement, nextAnnouncement, recentAnnouncements }) {
    ...
    return (
        <AuthenticatedLayout
            breadcrumbs={[
                { label: 'Announcements', href: route('resident.announcements.index') },
                        ...
                        <div className="lg:col-span-2">
                                ...
                                <div className="p-6 border-b border-gray-200">
                                    ...
                                    <div className="flex flex-wrap items-center gap-4 text-gray-600">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-sm">{announcement.created_at}</span>
                                        </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
                                {previousAnnouncement ? (
                                    <Link
                                        href={route('resident.announcements.show', previousAnnouncement.id)}
                                ...
                                {nextAnnouncement ? (
                                    <Link
                                        href={route('resident.announcements.show', nextAnnouncement.id)}
                                    ...
                                    <div className="bg-white rounded-xl shadow-lg p-6">
                                        ...
                                        <div className="space-y-4">
                                            {recentAnnouncements.map((recent) => (
                                                <Link
                                                    key={recent.id}
                                                    href={route('resident.announcements.show', recent.id)}
