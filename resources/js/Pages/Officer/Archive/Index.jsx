    ...
    return (
        <AuthenticatedLayout user={auth.user}>
            ...
            <ConfirmationModal
                ...
                confirmColor={confirmModal.type === 'restore' ? 'success' : 'danger'}
                confirmText={confirmModal.type === 'restore' ? 'Restore' : 'Delete Forever'}
                icon={confirmModal.type !== 'restore' ? Trash2 : CheckCircle}
                ConfirmButton={confirmModal.type !== 'restore' ? DangerButton : SuccessButton}
            />
        </AuthenticatedLayout>
    );
}
