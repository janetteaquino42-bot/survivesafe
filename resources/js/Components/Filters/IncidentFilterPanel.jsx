...
export default function IncidentFilterPanel({
    ...
    description = "Use the search bar to find specific incidents, or apply filters to narrow down results by type, status, severity, location, and date range.",
}) {
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                    <div className="flex-1">
                        <SearchBar
                            placeholder="Search by type, description, or barangay..."
                            ...
                            {incidentTypes.length > 0 && (
                                <Select
                                    ...
                                    options={[
                                        ...
                                        ...incidentTypes.map(t => ({ value: t.value, label: t.label }))
                                    ]}
                            ...
                            {incidentStatuses.length > 0 && (
                                <Select
                                    ...
                                    options={[
                                        ...
                                        ...incidentStatuses.map(s => ({ value: s.value, label: s.label }))
                                    ]}
                            ...
                            {incidentSeverities.length > 0 && (
                                <Select
                                    ...
                                    options={[
                                        ...
                                        ...incidentSeverities.map(s => ({ value: s.value, label: s.label }))
                                    ]}
